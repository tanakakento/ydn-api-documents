# Yahoo!ディスプレイアドネットワークレポート（V201907以降）
## パフォーマンスレポートとは
...
※こちらはYDN APIのV201907から有効なレポート作成方法です。<br>
<br>
広告管理ツールで提供しているレポート機能をAPIでもサポートしています。<br>

## YDN APIでの実施方法
YDN APIではレポートを表示するために、以下の Serviceを使用します。  

##### ReportDefinitionService 
ReportDefinitionServiceでは、レポート出力項目の取得およびレポート作成・取得・削除を行います。<br>

# シナリオ
パフォーマンスレポート取得のため、YDN APIを使い以下のレポートの作成から削除までのフローをご紹介します。  
...
不要なレポートを削除します。一定期間経過すると自動で削除されます。
